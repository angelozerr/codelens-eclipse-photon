...
public class CalleeAnalyzerVisitor extends HierarchicalASTVisitor {
	...
	public CalleeAnalyzerVisitor(CompilationUnit cu, List<ICodeMining> minings, ICodeMiningProvider provider) {
		this.cu= cu;
